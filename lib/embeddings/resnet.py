...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes= 512, zero_init_residual=False,
        ...
        self.n_interm_feat = 512 * block.expansion
...
class ResNet18(nn.Module):
    def __init__(self, block=BasicBlock, num_blocks=(2, 2, 2, 2), low_dim=512):
        super().__init__()
        self.in_planes = 64
...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    if pretrained:
        ...
        #                                       progress=progress)
        state_dict = torch.load('/Data_PHD/phd22_yijie_hu/C_FCIL/code/ResNet18_pretrained/resnet18-5c106cde.pth')
